 ...
 * Copyright (C) 1999-2015 Ciaran Anscomb <ewm@6809.org.uk>
...
unsigned int grabmask2 = ControlMask|Mod4Mask;
...
static const char *const def_volup[] = { DEF_VOLUP, NULL };
static const char *const def_voldown[] = { DEF_VOLDOWN, NULL };
static const char *const def_volmute[] = { DEF_VOLMUTE, NULL };
...
static struct xconfig_option ewm_options[] = {
...
int main(int argc, char *argv[]) {
...

	{
		...
		if (home) {
			...
			xconfig_parse_file(ewm_options, conffile);
			free(conffile);
		}
	}
	ret = xconfig_parse_cli(ewm_options, argc, argv, &argn);
