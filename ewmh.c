...
/* ewm atoms */
Atom xa_ewm_unmaximised_horz;
Atom xa_ewm_unmaximised_vert;
...
void ewmh_init(void) {
	...
	/* ewm atoms */
	xa_ewm_unmaximised_horz = XInternAtom(dpy, "_EVILWM_UNMAXIMISED_HORZ", False);
	xa_ewm_unmaximised_vert = XInternAtom(dpy, "_EVILWM_UNMAXIMISED_VERT", False);
